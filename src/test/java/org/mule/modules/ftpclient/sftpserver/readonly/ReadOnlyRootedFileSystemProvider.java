package org.mule.modules.ftpclient.sftpserver.readonly;
...
public class ReadOnlyRootedFileSystemProvider extends RootedFileSystemProvider {
    @Override
    protected FileSystem newFileSystem(final Object src, final Path path, final Map<String, ?> env) throws IOException {
